		...
		>
			<div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10 w-full py-6 md:py-4">
				...
				<div className="mb-4 text-center">
					<h2 className="text-xl md:text-2xl font-bold text-[#1de9b6] font-playfair mb-3 uppercase tracking-widest">
					...
					<div className="flex justify-center gap-3">
						<button
							...
							className={`px-6 py-2.5 rounded-full text-sm font-bold transition-all duration-300 ${activeTab === 'experience'
								? 'bg-[#1de9b6] text-[#0a1a14] shadow-[0_0_20px_rgba(29,233,182,0.4)]'
								: 'bg-[#1de9b6]/10 text-[#1de9b6] border border-[#1de9b6]/30 hover:bg-[#1de9b6]/20'
								}`}
						>
							EXPERIENCE
						</button>
				...
				<div className="relative">
					...
					<div className="absolute left-8 md:left-10 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#1de9b6] via-[#1de9b6]/50 to-transparent"></div>
					
					<div className="space-y-4 relative">
						{displayData.map((item, index) => (
							<div key={item._id || index} className="relative pl-16 md:pl-20">
								{/* Timeline Node */}
								<div className="absolute left-6 md:left-8 top-8 w-4 h-4 rounded-full bg-[#1de9b6] border-4 border-[#0a1a14] shadow-[0_0_10px_rgba(29,233,182,0.5)] z-10"></div>
	...
	return (
		<div className="w-full" style={{ perspective: "1000px" }}>
			<div
				...
				className={`relative rounded-xl p-5 md:p-6 border transition-all duration-500 w-full cursor-pointer overflow-hidden ${isHovered
					? 'border-[#1de9b6]/50 shadow-[0_0_30px_rgba(29,233,182,0.15)]'
					: 'border-white/10 hover:border-white/20'
					}`}
			>
				{/* Decorative corner accent */}
				<div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-[#1de9b6]/10 to-transparent rounded-bl-full opacity-0 group-hover:opacity-100 transition-opacity"></div>
				...
				<div className="flex flex-col md:flex-row justify-between items-start gap-4 relative z-10">
					<div className="flex gap-5 md:gap-6 items-start flex-1 w-full">
						...
						{exp.logo ? (
							<div className="w-12 h-12 md:w-14 md:h-14 rounded-xl flex items-center justify-center flex-shrink-0 overflow-hidden border border-[#1de9b6]/20 bg-gradient-to-br from-white/10 to-white/5 shadow-md">
								<img src={exp.logo} alt={exp.company} className="w-full h-full object-contain p-1.5" />
							</div>
						) : (
							<div className="w-12 h-12 md:w-14 md:h-14 rounded-xl flex items-center justify-center flex-shrink-0 border border-[#1de9b6]/20 bg-gradient-to-br from-[#1de9b6]/20 to-[#1de9b6]/5 shadow-md">
						...
						<div className="flex-1 w-full pt-1">
							<div className="flex flex-wrap items-center gap-3 mb-2">
								<h3 className="text-white font-bold text-lg md:text-xl tracking-tight" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>{exp.role}</h3>
								{exp.isCurrent && (
									<span className="px-3 py-1 bg-[#1de9b6]/20 text-[#1de9b6] text-xs font-bold uppercase tracking-wider rounded-full border border-[#1de9b6]/30">
										Current
									</span>
								)}
							</div>
							...
							<div className="flex flex-wrap items-center gap-x-4 gap-y-2 mb-4">
								<p className="text-[#1de9b6] text-base font-bold tracking-wide" style={{ fontFamily: "'Outfit', sans-serif" }}>
									{exp.company}
								</p>
								{exp.location && (
									<div className="flex items-center gap-1.5 text-gray-400 text-sm" style={{ fontFamily: "'Outfit', sans-serif" }}>
										<svg className="w-4 h-4 text-[#1de9b6]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							...
							<p className="text-gray-300 text-sm leading-relaxed max-w-4xl mb-3" style={{ fontFamily: "'Outfit', sans-serif" }}>
								{exp.description}
							</p>
					...
					<div className="flex flex-col items-end gap-3 self-start">
						<div className="flex items-center gap-2 bg-gradient-to-r from-[#1de9b6]/10 to-[#1de9b6]/5 border border-[#1de9b6]/20 rounded-xl px-4 py-2 whitespace-nowrap shadow-lg">
							<svg className="w-4 h-4 text-[#1de9b6]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
								<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
							</svg>
							<span className="text-gray-300 text-sm font-semibold" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
								{exp.startDate} - {exp.endDate}
							</span>
						</div>
						{exp.duration && (
							<div className="text-xs text-gray-500 uppercase tracking-wider" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
								{exp.duration}
							</div>
						)}
					</div>
...
const Tag = ({ tag }) => {
	...
	return (
		<span
			...
			className={`text-xs md:text-sm px-3 py-1.5 md:px-4 md:py-2 rounded-full border cursor-pointer transition-all duration-300 font-semibold ${isHovered
				? 'bg-[#1de9b6] text-[#0a1a14] border-[#1de9b6] shadow-[0_0_15px_rgba(29,233,182,0.5)] scale-105'
				: 'bg-[#1de9b6]/10 text-[#1de9b6] border-[#1de9b6]/30 hover:bg-[#1de9b6]/20'
				}`}
