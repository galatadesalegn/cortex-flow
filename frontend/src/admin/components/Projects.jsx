      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className={`lg:col-span-3 border rounded-xl p-6 transition-all duration-300 ${isDark ? 'bg-[#12121a] border-gray-800 hover:border-gray-700' : 'bg-bg-card border-border-theme shadow-soft'
          ...
          {!loading && !error && (
            <>
              {/* Table Header */}
              <div className={`hidden md:grid grid-cols-4 gap-4 px-4 py-3 rounded-lg mb-3 transition-colors duration-300 ${isDark ? 'bg-gray-800/50' : 'bg-bg-secondary'
                }`}>
              ...
              <div className="space-y-4 md:space-y-2">
                {projectList.length === 0 ? (
                  ...
                  projectList.map((project) => (
                    <div
                      key={project.id}
                      className={`flex flex-col md:grid md:grid-cols-4 gap-4 px-4 py-4 md:py-3 rounded-lg border border-transparent transition-all group relative ${isDark ? 'bg-gray-800/30 hover:bg-gray-800/50 hover:border-blue-600/30' : 'bg-bg-secondary/50 hover:bg-bg-accent hover:border-accent/30 shadow-sm'
                        }`}>
                      ...
                      <div className="flex md:block justify-between items-center" onClick={() => setSelectedProject(project)}>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex md:block justify-between items-center w-full md:w-auto" onClick={() => setSelectedProject(project)}>
