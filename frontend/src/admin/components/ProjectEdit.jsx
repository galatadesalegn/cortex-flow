  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const dataToSubmit = {
        ...
        image: formData.image || project?.image || null,
        ...
        category: formData.category?.trim() || project?.category || 'Other',
        duration: formData.duration?.trim() || project?.duration || null,
        collaborationType: formData.collaborationType || project?.collaborationType || 'Solo',
        videoUrl: formData.videoUrl?.trim() || project?.videoUrl || null
      };
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <h1 className={`text-2xl font-bold transition-colors duration-300 ${isDark ? 'text-white' : 'text-text-primary'}`}>Edit Project</h1>
          </div>
        </div>
