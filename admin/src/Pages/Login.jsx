  ...
  return (
    <div className="min-h-screen w-full bg-[#0a0a0f] flex">
      ...
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-950 via-[#0a0a0f] to-black" />

        {/* Animated gradient orbs */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-600/30 rounded-full blur-[120px] animate-pulse" />
          <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-cyan-500/20 rounded-full blur-[100px] animate-pulse delay-700" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-purple-600/20 rounded-full blur-[90px] animate-pulse delay-500" />
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 h-full">
          ...
          <div className="flex items-center gap-3">
            <div className="relative w-12 h-12">
              ...
              <div className="absolute inset-[2px] rounded-xl bg-[#0a0a0f] flex items-center justify-center">
                <Shield className="w-6 h-6 text-cyan-400" />
              </div>
            </div>
            <div>
              <span className="text-white font-bold text-xl tracking-tight">Galata.D</span>
      ...
      <div className="w-full lg:w-[55%] flex items-center justify-center p-6 lg:p-12 relative">
        {/* Background gradient */}
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-[#0a0a0f] to-black" />
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-[#12121a]/90 backdrop-blur-2xl border border-gray-800 rounded-2xl p-8 hover:border-gray-700/50 transition-all duration-500">
              {!showForgotPassword ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                  />
                  <label className="absolute left-12 top-4 text-gray-500 text-sm transition-all duration-300
                    peer-focus:-top-2.5 peer-focus:left-3 peer-focus:text-xs peer-focus:text-blue-400 peer-focus:bg-[#12121a] peer-focus:px-2
                    peer-not-placeholder-shown:-top-2.5 peer-not-placeholder-shown:left-3 peer-not-placeholder-shown:text-xs peer-not-placeholder-shown:text-gray-400 peer-not-placeholder-shown:bg-[#12121a] peer-not-placeholder-shown:px-2
                    pointer-events-none">
                    Email Address
                  </label>
                </div>
