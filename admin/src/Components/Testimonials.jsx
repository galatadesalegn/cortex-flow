...
import { useTestimonials, useCreateTestimonial, useUpdateTestimonial, useDeleteTestimonial, useToggleTestimonial, useUpload } from '../hooks';
  ...
  const renderStars = (rating) => {
    return Array(5).fill(0).map((_, i) => (
      <Star
        key={i}
        size={12}
        className={i < rating ? 'text-[#1de9b6] fill-[#1de9b6]' : 'text-gray-600'}
      />
    ));
  };
    ...
    <div className="p-6">
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#1de9b6] hover:bg-[#1de9b6]/90 text-[#0a0a0a] px-5 py-2.5 rounded-lg text-sm font-bold transition-all"
        >
          <Plus size={18} />
          Add Testimonial
        </button>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials?.map((testimonial) => (
            <div
              key={testimonial._id}
              className={`bg-[#0c0c0c] rounded-xl border ${testimonial.active ? 'border-[#1de9b6]/20' : 'border-gray-800'} p-5 transition-all hover:border-[#1de9b6]/40`}
            >
              {/* Header */}
                ...
                <div className="flex items-center gap-3">
                  {testimonial.avatar ? (
                    <img
                      ...
                      className="w-12 h-12 rounded-full object-cover border border-[#1de9b6]/30"
                    />
                  ) : (
                    <div className="w-12 h-12 rounded-full bg-[#1de9b6]/10 border border-[#1de9b6]/30 flex items-center justify-center">
                      <span className="text-[#1de9b6] font-bold text-lg">
                  ...
                  <div>
                    ...
                    <p className="text-[#1de9b6]/70 text-xs">{testimonial.company}</p>
                  </div>
                </div>
              ...
              {/* Content */}
              <div className="mb-4">
                <Quote size={16} className="text-[#1de9b6]/30 mb-2" />
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/5">
                <div className="flex items-center gap-2">
                  {testimonial.verified && (
                    <span className="flex items-center gap-1 text-[10px] text-[#1de9b6] bg-[#1de9b6]/10 px-2 py-1 rounded-full">
                      <CheckCircle size={10} />
                      Verified
                    </span>
                  )}
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    {testimonial.active ? <CheckCircle size={16} /> : <XCircle size={16} />}
                  </button>
                  <button
