  ...
  return (
    <div className="p-6 bg-[#0a0a0f] min-h-screen">
      ...
      <div className="flex items-start justify-between mb-8">
        <div>
          <p className="text-xs text-gray-500 uppercase tracking-widest mb-1">ROOT / ENGINE / SKILLS_MATRIX</p>
          <h1 className="text-3xl font-bold text-white mb-2">Skills Management</h1>
          <p className="text-gray-500">Technical proficiency matrix and architectural competence index.</p>
        </div>
