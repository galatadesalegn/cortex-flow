...
const Messages = () => {
  ...
  const getPriorityBadge = (priority) => {
    switch(priority) {
      ...
      case 'medium':
        return (
          <span className="px-2 py-0.5 rounded text-[10px] font-semibold bg-yellow-500/20 text-yellow-400 border border-yellow-500/30 uppercase tracking-wider">
            Medium
          </span>
        );
      default:
        return (
          <span className="px-2 py-0.5 rounded text-[10px] font-semibold bg-gray-500/20 text-gray-400 border border-gray-500/30 uppercase tracking-wider">
            Low
          </span>
        );
    }
